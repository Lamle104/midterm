...
#   however, if a $10 minimum payment exceeds the balance, then the minimum payment is the balance. Write a program to return the minimum payment.
...
def computeMinimumPayment( balance ): 
    ...
    if balance * 0.021 > 10:  #if balance is greater than 10 or 2.1% of customers balance
        ...
        return 10 #return 10 dollar minimum payment
